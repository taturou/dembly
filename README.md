...
Compose Base lifecycle、named-image-user の passwd probe、`check` lifecycle、full Docker integration suite は現在実装途中です。
...
override planner は実装済みですが、Compose lifecycle command は未実装です。
