...
pub use client::{
    ...
    compose_service_image, compose_status, container_label, docker_status, exec_in_container,
    image_identity, inspect_image, probe_image_user, run_docker, ImageConfig, ProbedUser,
};
